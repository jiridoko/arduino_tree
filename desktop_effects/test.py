...
# I got this from http://menno.io/posts/pulseaudio_monitoring/
...
def main():
    ...
    maxval = 0
    requests.get("http://172.16.32.144/api/mode_direct/")
    ### count = 0
    for sample in monitor:
        ...
        requests.get("http://172.16.32.144/direct/"+base64.b64encode(out)+"/")
        #print "http://172.16.32.144/direct/"+base64.b64encode(out)+"/"
