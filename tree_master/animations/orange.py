...
class orange(__animation.animation):
    def __init__(self, led):
        super(orange, self).__init__(led, "orange")
        self.initialize_argument("cp_orange_colour", "Colour: ", default_value="ff0f00")
        self.reset()

    def reset(self):
        c=str(self.get_argument("cp_orange_colour"))
